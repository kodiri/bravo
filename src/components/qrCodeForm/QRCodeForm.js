...
export default function QRCodeForm() {
  const ref = firebase.firestore().collection("qrs");
        ...
        <form onSubmit={handleSubmit}>
          <div className="tapInputRow">
            ...
            <input
              ...
              id="title"
              type="text"
              placeholder="Enter Title for Qr"
              name="title"
              value={title}
            ...
            <input
              ...
              onChange={e => setTitleSelected(!titleSelected)}
            />
          </div>
          <div className="tapInputRow">
          ...
          <input type="submit" name="submit" value="Create QR Code" />
        </form>
      </div>
